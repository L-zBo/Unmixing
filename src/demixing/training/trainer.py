...
from demixing.training.losses import anchor_penalty, ordinal_label_loss, smoothness_penalty, spectral_angle_loss
...
def train_model(
    ...
    for epoch in range(config.epochs):
        ...
        history.append({"epoch": epoch + 1, "loss": epoch_loss / max(len(dataloader), 1)})
    return history
